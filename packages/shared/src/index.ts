...
export type SessionEvent =
  | { type: "user"; text: string; timestamp: string; runId?: string }
  | { type: "assistant"; text: string; timestamp: string; runId?: string }
  | { type: "tool_call"; toolName: string; callId: string; input: Record<string, unknown>; timestamp: string; runId?: string }
  | { type: "tool_result"; toolName: string; callId: string; result: ToolResult; timestamp: string; runId?: string };
